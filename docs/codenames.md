...
|----------|-------------|------|------|
| Cordova    | Codename for one of the ODD hardware revisions | Hardware | N/A |
| Lancaster  | Codename for one of the ODD hardware revisions | Hardware | N/A |
| Monterey   | Codename for one of the ODD hardware revisions | Hardware | N/A |
...
| Xiphos | Codename for the GIP (Gamepad Input Provider) service   |  Software | N/A |
